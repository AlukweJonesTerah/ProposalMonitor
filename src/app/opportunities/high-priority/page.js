...
export default function HighPriority() {
  return (
    <>
      <SiteHeader active="high-priority" />
      <main className="container max-w-[1040px] py-10">
        ...
        <h1 className="mt-4 font-serif text-4xl font-bold tracking-tight">High-priority opportunities</h1>
        <OpportunityBrowser highOnly />
      </main>
    </>
  );
}
