...
export default function SourceIntakePage({ brand = PROPOSAL_MONITOR_BRAND }) {
  ...
  return (
    <>
      <SiteHeader active="source-intake" brand={brand} />
      <main className="container max-w-[1040px] py-10">
        ...
        <Card className="mt-7">
          <CardContent className="pt-6">
            ...
            <Link href={`${brand.basePath}/sources/review`} className="mt-4 inline-block text-sm font-bold text-primary no-underline hover:underline">Review submitted sources →</Link>
          </CardContent>
        </Card>
      </main>
    </>
